...
I will try to build my model in a way that it can retrieve tweets about any coin, but since the database storage will be limited I will primarily concentrate on Bitcoin since it is the one that has started the whole cryptocurrency era and the most followers and talk about it.
